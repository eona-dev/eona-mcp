...
EONA_MCP_PRODUCTION_VERSION="0.1.10"
CLI_MIN_VERSION="0.1.9"
DEFAULT_CLI_BOOTSTRAP_VERSION="0.1.9"
SOURCE_ROOT="${EONA_MCP_SOURCE_ROOT:-}"
MCP_ARTIFACT_URL="${EONA_MCP_ARTIFACT_URL:-https://release.eona.dev}"
